...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,818 | 🐛 106 | 📅 2026-09-02
...
* [neo4j-python-driver](https://github.com/neo4j/neo4j-python-driver) ⭐ 1,048 | 🐛 8 | 🌐 Python | 📅 2026-09-11 - Python driver for Neo4j binary protocol.
...
* [neo4j-spark-connector](https://github.com/neo4j-contrib/neo4j-spark-connector) ⭐ 324 | 🐛 11 | 🌐 Scala | 📅 2026-09-11 - Neo4j-Spark-Connector based on Neo4j 3.0's Bolt protocol
...
* [neomodel](https://github.com/neo4j-contrib/neomodel) ⭐ 1,089 | 🐛 47 | 🌐 Python | 📅 2026-08-26 - An Object Graph Mapper (OGM) for the neo4j graph database, built on the awesome py2neo.
...
* [cypher-dsl](https://github.com/neo4j-contrib/cypher-dsl) ⭐ 227 | 🐛 8 | 🌐 Java | 📅 2026-09-11 - A Java DSL for the Cypher Query Language and an optional Query DSL mode.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,647 | 🐛 444 | 🌐 Java | 📅 2026-09-13 - Gephi is an award-winning open-source platform for visualizing and manipulating large graphs.
