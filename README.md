...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,113 | 🐛 106 | 📅 2026-09-02
...
* [neo4j-python-driver](https://github.com/neo4j/neo4j-python-driver) ⭐ 1,048 | 🐛 9 | 🌐 Python | 📅 2026-09-11 - Python driver for Neo4j binary protocol.
...
* [neo4j-spark-connector](https://github.com/neo4j-contrib/neo4j-spark-connector) ⭐ 324 | 🐛 9 | 🌐 Scala | 📅 2026-09-14 - Neo4j-Spark-Connector based on Neo4j 3.0's Bolt protocol
...
* [neo4j-dotnet-driver](https://github.com/neo4j/neo4j-dotnet-driver) ⭐ 247 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - .Net driver for Neo4j (Bolt).
...
* [spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) ⭐ 867 | 🐛 34 | 🌐 Java | 📅 2026-09-14 - Provides support to increase developer productivity in Java when using the neo4j graph database.
* [neo4j-ogm](https://github.com/neo4j/neo4j-ogm) ⭐ 360 | 🐛 8 | 🌐 Java | 📅 2026-09-14 - Object-Graph Mapping Library for Neo4j.
* [neo4j-jdbc](https://github.com/neo4j-contrib/neo4j-jdbc) ⭐ 154 | 🐛 22 | 🌐 Java | 📅 2026-09-14 - Neo4j JDBC driver.
...
* [neomodel](https://github.com/neo4j-contrib/neomodel) ⭐ 1,088 | 🐛 47 | 🌐 Python | 📅 2026-08-26 - An Object Graph Mapper (OGM) for the neo4j graph database, built on the awesome py2neo.
...
* [docker-neo4j](https://github.com/neo4j/docker-neo4j) ⭐ 383 | 🐛 68 | 🌐 Shell | 📅 2026-09-11 - Docker Images for the Neo4j Graph Database.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,649 | 🐛 444 | 🌐 Java | 📅 2026-09-13 - Gephi is an award-winning open-source platform for visualizing and manipulating large graphs.
