...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,252 | 🐛 105 | 📅 2026-08-18
...
* [neo4j-javascript-driver](https://github.com/neo4j/neo4j-javascript-driver) ⭐ 917 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-20 - JavaScript driver for Neo4j binary protocol.
* [neo4j-java-driver](https://github.com/neo4j/neo4j-java-driver) ⭐ 347 | 🐛 1 | 🌐 Java | 📅 2026-08-19 - Java driver for Neo4j binary protocol.
* [neo4j-spark-connector](https://github.com/neo4j-contrib/neo4j-spark-connector) ⭐ 324 | 🐛 7 | 🌐 Scala | 📅 2026-08-20 - Neo4j-Spark-Connector based on Neo4j 3.0's Bolt protocol
...
* [spring-data-neo4j](https://github.com/spring-projects/spring-data-neo4j) ⭐ 866 | 🐛 35 | 🌐 Java | 📅 2026-08-20 - Provides support to increase developer productivity in Java when using the neo4j graph database.
* [neo4j-ogm](https://github.com/neo4j/neo4j-ogm) ⭐ 360 | 🐛 3 | 🌐 Java | 📅 2026-08-20 - Object-Graph Mapping Library for Neo4j.
...
* [neomodel](https://github.com/neo4j-contrib/neomodel) ⭐ 1,087 | 🐛 46 | 🌐 Python | 📅 2026-07-16 - An Object Graph Mapper (OGM) for the neo4j graph database, built on the awesome py2neo.
...
* [cypher-dsl](https://github.com/neo4j-contrib/cypher-dsl) ⭐ 226 | 🐛 14 | 🌐 Java | 📅 2026-08-17 - A Java DSL for the Cypher Query Language and an optional Query DSL mode.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,617 | 🐛 520 | 🌐 Java | 📅 2026-08-19 - Gephi is an award-winning open-source platform for visualizing and manipulating large graphs.
