...
* [neo4j-python-driver](https://github.com/neo4j/neo4j-python-driver) ⭐ 1,050 | 🐛 13 | 🌐 Python | 📅 2026-09-02 - Python driver for Neo4j binary protocol.
...
* [neo4j-spark-connector](https://github.com/neo4j-contrib/neo4j-spark-connector) ⭐ 324 | 🐛 9 | 🌐 Scala | 📅 2026-09-02 - Neo4j-Spark-Connector based on Neo4j 3.0's Bolt protocol
...
* [neo4j-dotnet-driver](https://github.com/neo4j/neo4j-dotnet-driver) ⭐ 247 | 🐛 2 | 🌐 C# | 📅 2026-09-01 - .Net driver for Neo4j (Bolt).
...
* [neo4j-jdbc](https://github.com/neo4j-contrib/neo4j-jdbc) ⭐ 154 | 🐛 17 | 🌐 Java | 📅 2026-09-02 - Neo4j JDBC driver.
...
* [cypher-dsl](https://github.com/neo4j-contrib/cypher-dsl) ⭐ 227 | 🐛 9 | 🌐 Java | 📅 2026-09-02 - A Java DSL for the Cypher Query Language and an optional Query DSL mode.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,629 | 🐛 445 | 🌐 Java | 📅 2026-08-31 - Gephi is an award-winning open-source platform for visualizing and manipulating large graphs.
